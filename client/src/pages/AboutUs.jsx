...
export function AboutUs() {
  ...
  return (
    <div>
      <header className="relative w-full pb-4 bg-white border-b">
            ...
            <div className="absolute inset-x-0 top-0 z-50 p-2 transition origin-top-right transform lg:hidden">
              <div className="bg-white divide-y-2 rounded-lg shadow-lg divide-gray-50 ring-1 ring-black ring-opacity-5">
                <div className="px-5 pt-5 pb-6">
                  ...
                  <button
                    type="button"
                    className="w-full px-3 py-2 mt-4 text-sm font-semibold text-white bg-black rounded-md shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Button text
                  </button>
                </div>
      ...
      <div className="px-4 mx-auto max-w-7xl">
        ...
        {/* TEAM */}
        <div className="grid grid-cols-1 gap-4 py-12 pb-20 border-b border-gray-300 gap-y-6 md:grid-cols-2 lg:grid-cols-4">
          {users.map((user) => (
            <div className="border rounded-md" key={user.name}>
              <img
                src={user.image}
                alt={user.name}
                className="h-[300px] w-full rounded-lg object-cover "
              />
              <p className="w-full px-2 mt-6 text-xl font-semibold text-gray-900">{user.name}</p>
        ...
        <div className="flex flex-col items-center py-16 gap-x-4 gap-y-4 md:flex-row">
          ...
          <div className="w-full mt-10 md:mt-o">
            <img
      ...
      <div className="mx-auto max-w-7xl">
        <footer className="px-4 py-10">
          ...
          <div className="grid grid-cols-2 mt-16 md:grid-cols-3 lg:grid-cols-5">
